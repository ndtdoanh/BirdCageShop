            ...
            <div class="content-agile2">
                <form action="ForgotPassword" method="post">
                    <div class="form-control w3layouts"> 
                        <input type="text" id="UserID" name="email" placeholder="Nhập email của bạn" required="">
                    </div>	
                    <button type="submit" name="action" class="register" value="Login"> Gửi email </button>
                    </form>
