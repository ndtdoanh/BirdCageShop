...
public class FeedbackController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String orderId = fbd.getOrdeIdrByCageId(id);
        FeedBack fb = new FeedBack(feedbackDate, u.getUserID(), orderId, u.getFullName(), rate, feedback);
        fbd.createFeedbackByUserId(fb);
