        ...
        <div class="content-w3ls">
            ...
            <div class="content-agile2">
                    ...
                    <div class="form-control w3layouts"> 
                        <input type="text" id="UserID" name="code" placeholder="Nhập mã xác nhận..." required="">
                    </div>
                    <button type="submit" name="action" class="register" value="Login"> Xác nhận </button>
                    </form>
                    <% } %>
