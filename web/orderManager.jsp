                            ...
                            <tbody>
                                <c:forEach items="${listOrder}" var="o">
                                    <tr>
                                        ...
                                        <td class="text-center text-lg text-medium"><a href="DetailOrderAdmin?orderId=${o.orderID}" class="round-button"><i class="fa-solid fa-eye" style="color: white;"></i></a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
