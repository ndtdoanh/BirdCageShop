 ...
 * @author Admin
 */
@WebServlet(name = "DetailOrderAdmin", urlPatterns = {"/DetailOrderAdmin"})
public class DetailOrderAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("detailOrderAdmin.jsp").forward(request, response);
    }
