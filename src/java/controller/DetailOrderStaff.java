 ...
 * @author Admin
 */
@WebServlet(name = "DetailOrderStaff", urlPatterns = {"/DetailOrderStaff"})
public class DetailOrderStaff extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("detailOrderStaff.jsp").forward(request, response);
    }
