...
<html>
    ...
    <body class="fade-in">
        ...
        <div class="container padding-bottom-3x my-3">
            <!-- Shopping Cart-->
            ...
            <div class="shopping-cart-footer">
                ...
                <h5 class="column text-lg cart__total" ">Tổng thanh toán: <span class="text-medium cart__price__total" ><%= nf.format(total) %> VNĐ</span></h5>
