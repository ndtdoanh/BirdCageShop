<%-- 
    ...
    Created on : Sep 22, 2023, 11:27:54 PM
    Author     : HOANGDUC
--%>
   ...
   <div class="row row-main">
        <div class="large-12 col">
            <div class="col-inner container">
                ...
                <h2><b>1. Sản phẩm Birdcage giao không đúng đơn đặt hàng</b></h2>
                <p><span style="font-weight: 400;">Bạn nghĩ rằng sản phẩm giao cho bạn không đúng với đơn đặt hàng? Hãy
                        ...
                        hàng).</span></p>
                <h2><b>2. Sản phẩm mua rồi nhưng không ưng ý</b></h2>
                ...
                <h2><b>3. Sản phẩm mua bị lỗi</b></h2>
                ...
                <p><span style="font-weight: 400;">– Hàng hóa còn đầy đủ các bộ phận, không có dấu hiệu sử dụng quá
                        nhiều hoặc hỏng hóc.</span></p>
                <p><span style="font-weight: 400;">– Có đầy đủ các giấy tờ kèm theo (hóa đơn mua hàng hoặc phiếu bảo
                        hành .) và các linh kiện, tặng phẩm kèm theo (nếu có).</span></p>
                <p><span style="font-weight: 400;">– Khách hàng chịu chi phí vận chuyển cho việc đổi, trả hàng.</span>
                </p>
                <p><span style="font-weight: 400;">– Trường hợp không đủ các điều kiện trên thì quyền quyết định đổi,
                        trả hàng thuộc về longchim.vn</span></p>
            </div>
        </div>
    </div>
    <!-- end main -->
